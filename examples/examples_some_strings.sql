...
DROP TABLE IF EXISTS `some_strings`;
...
LOCK TABLES `some_strings` WRITE;
/*!40000 ALTER TABLE `some_strings` DISABLE KEYS */;
INSERT INTO `some_strings` VALUES ('1234567','Some crazy text','');
/*!40000 ALTER TABLE `some_strings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-04-15 22:04:03
